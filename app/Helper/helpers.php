...
return strtolower(date_format($date,"d/m/Y h:i A"));
}
...
function check_role1($UserID,$TableName,$Action)
{
		// action is (list,view,updat,delete etc)
		$check = DB::table('user_role')->where('UserID',$UserID)
 										->where('Table',$TableName)
...
function check_hr_role($UserID,$BranchID,$TableName,$Action)
{
		// action is (list,view,updat,delete etc)
		$check = DB::table('user_role')->where('UserID',$UserID)
										...
										// ->where('Action',$Action)
 										->count();
 										// dd($UserID,$BranchID,$TableName,$Action,$check);
