                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="mb-3"><label for="basicpill-firstname-input" class="pr-5">Upload
                                                    Picture</label><br><input type="file" name="picture"
                                                ...
                                                <select name="BranchID" id="BranchID" class="form-select">
                                                    ...
                                                    @foreach ($branch as $value)
                                                        <option value="{{ $value->BranchID }}"
                                                            {{ $employee->BranchID == $value->BranchID ? 'selected' : '' }}>
                                                ...
                                                <select name="StaffType" id="StaffType" class="form-select">
                                                    ...
                                                    @foreach ($staff_type as $value)
                                                        <option value="{{ $value->StaffType }}"
                                                            {{ $StaffType == $value->StaffType ? 'selected' : '' }}>
                                                ...
                                                <select name="Title" id="Title" class="form-select">
                                                    ...
                                                    @foreach ($title as $value)
                                                        <option value="{{ $value->Title }}"
                                                            {{ $employee->Title == $value->Title ? 'selected' : '' }}>
                                                            {{ $value->Title }}</option>
                                                    @endforeach
                                                ...
                                                <select name="Nationality" id="Nationality" class="form-select select2">
                                                    @foreach ($country as $value)
                                                        <option value="{{ $value->CountryName }}"
                                                            {{ $employee->Nationality == $value->CountryName ? 'selected' : '' }}>
                                        ...
                                        <div class="col-md-4">
                                            <div class="mb-3">
                                                ...
                                                <select name="EducationLevel" id="EducationLevel" class="form-select">
                                                    ...
                                                    @foreach ($educationlevel as $row)
                                                        <option value="{{ $row->EducationLevelName }}"
                                                            {{ $employee->EducationLevel == $row->EducationLevelName ? 'selected' : '' }}>
                                                            {{ $row->EducationLevelName }}</option>
                                                    @endforeach
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4 ">
                                            <div class="mb-3">
                                                ...
                                                <input type="date" class="form-control" name="VisaIssueDate"
                                                    value="{{ old('VisaIssueDate', $employee->VisaIssueDate) }}">
                                        ...
                                        <div class="col-md-4">
                                            <div class="mb-3">
                                                ...
                                                <input type="date" class="form-control" name="VisaExpiryDate"
                                                    value="{{ old('VisaExpiryDate', $employee->VisaExpiryDate) }}">
                                        ...
                                        <div class="col-md-4">
                                            <div class="mb-3">
                                                ...
                                                <input name="PassportNo" class="form-control"
                                                    value="{{ old('PassportNo', $employee->PassportNo) }}">
                                        ...
                                        <div class="col-md-4">
                                            <div class="mb-3">
                                                ...
                                                <input type="date" class="form-control" name="PassportExpiry"
                                                    value="{{ old('PassportExpiry', $employee->PassportExpiry) }}">
                                        ...
                                        <div class="col-md-4">
                                            <div class="mb-3">
                                                ...
                                                <input name="EidNo" class="form-control"
                                                    value="{{ old('EidNo', $employee->EidNo)  }}">
                                        ...
                                        <div class="col-md-4">
                                            <div class="mb-3">
                                                ...
                                                <input type="date" class="form-control" name="EidExpiry"
                                                    value="{{ old('EidExpiry', $employee->EidExpiry) }}">
                                                ...
                                                <select name="JobTitleID" id="JobTitleID" class="form-select">
                                                    ...
                                                    @foreach ($jobtitle as $value)
                                                        <option value="{{ $value->JobTitleID }}"
                                                            {{ $employee->JobTitleID == $value->JobTitleID ? 'selected' : '' }}>
                                                ...
                                                <select name="DepartmentID" id="DepartmentID" class="form-select">
                                                    ...
                                                    @foreach ($department as $value)
                                                        <option value="{{ $value->DepartmentID }}"
                                                            {{ $employee->DepartmentID == $value->DepartmentID ? 'selected' : '' }}>
                                                ...
                                                <select name="SupervisorID" id="SupervisorID"
                                                    ...
                                                    @foreach ($supervisor as $value)
                                                        <option value="{{ $value->EmployeeID }}"
                                                            {{ $employee->SupervisorID == $value->EmployeeID ? 'selected' : '' }}>
                                                ...
                                                <select name="SalaryTypeID" class="form-select">
                                                    ...
                                                    @foreach ($salary_type as $value)
                                                        <option value="{{ $value->SalaryTypeID }}"
                                                            {{ $value->SalaryTypeID == $employee->SalaryTypeID ? 'selected' : '' }}>
