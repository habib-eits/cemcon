                            ...
                            <div class="col-12">
                                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                    ...
                                    <div class="page-title-right ">
                                        <strong class="text-danger">{{session::get('UserID')}}-{{session::get('UserType')}}-{{session::get('Email')}}</strong>
                                        ...
                                        <div class="card">
                                            <div class="card-body border-secondary border-top border-3 rounded-top shadow-sm">
                                                ...
                                                <div class="text-muted mt-4">
                                                    <h4 class="text-center"><a href="#">{{($sale[0]->Total==null) ? '0' : number_format($sale[0]->Total) }} </a> </h4>
                                                    <div class="d-flex">
                                    ...
                                    <div class="col-sm-3">
                                        <div class="card">
                                            <div class="card-body border-secondary border-top border-3 rounded-top  shadow-sm">
                                                ...
                                                <div class="text-muted mt-4">
                                                    <h4 class="text-center"><a href="#" >{{($expense[0]->Balance ==null) ? '0' :  number_format($expense[0]->Balance)}}  </a> </h4>
                                                    <div class="d-flex">
                                                         <span class="ms-2 text-truncate mt-3"> </span>
                                                    </div>
                                                </div>
                                    ...
                                    <div class="col-sm-3">
                                        <div class="card">
                                            <div class="card-body border-secondary border-top border-3 rounded-top  shadow-sm">
                                                ...
                                                <div class="text-muted mt-4">
                                                    <h4 class="text-center"><a href="#">{{($revenue[0]->Balance ==null) ? '0' :  number_format($revenue[0]->Balance)}} 
                                        ...
                                        <div class="card">
                                            <div class="card-body border-success border-top border-3 rounded-top shadow-sm">
                                                ...
                                                <div class="text-muted mt-0">
                                                    <h4 class="text-center"><a href="{{URL('/Booking')}}">{{($total_booking==null) ? '0' : number_format($total_booking) }} </a> </h4>
                                    ...
                                    <div class="col-sm-2">
                                        <div class="card">
                                            <div class="card-body border-info border-top border-3 rounded-top  shadow-sm">
                                                ...
                                                <div class="text-muted mt-0">
                                                    <h4 class="text-center"><a href="{{URL('/leads')}}" >{{($total_leads==null) ? '0' : number_format($total_leads) }}  </a> </h4>
                                    ...
                                    <div class="col-sm-2">
                                        <div class="card">
                                            <div class="card-body border-danger border-top border-3 rounded-top  shadow-sm">
                                                ...
                                                <div class="text-muted mt-0">
                                                    <h4 class="text-center"><a href="{{URL('/leads')}}">{{($leads_won==null) ? '0' : number_format($leads_won) }} 
                                      ...
                                      <div class="col-sm-2">
                                        <div class="card">
                                            <div class="card-body border-warning border-top border-3 rounded-top  shadow-sm">
                                                ...
                                                <div class="text-muted mt-0">
                                                    <h4 class="text-center"><a href="{{URL('/leads')}}">{{($leads_lost==null) ? '0' : number_format($leads_lost) }}</a> </h4>
                                      ...
                                      <div class="col-sm-2">
                                        <div class="card">
                                            <div class="card-body border-secondary border-top border-3 rounded-top  shadow-sm">
                                                ...
                                                <div class="text-muted mt-0">
                                                    <h4 class="text-center"><a href="{{URL('/leads')}}">{{($leads_new==null) ? '0' : number_format($leads_new) }}</a> </h4>
                                      ...
                                      <div class="col-sm-2">
                                        <div class="card">
                                            <div class="card-body border-primary border-top border-3 rounded-top  shadow-sm">
                                                ...
                                                <div class="text-muted mt-0">
                                                    <h4 class="text-center"><a href="{{URL('/leads')}}">{{($leads_reject==null) ? '0' : number_format($leads_reject) }}</a> </h4>
