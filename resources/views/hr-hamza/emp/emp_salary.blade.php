                    ...
                    <div class="col-xl-9">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <form action="{{ route('employee.allowance.save', $employee->EmployeeID) }}" method="post"
                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="mb-3">
                                                ...
                                                <select name="AllowanceListID" id="AllowanceListID"
                                                    class="form-select form-select-sm">
                                                    <?php foreach ($allowance as $key => $value): ?>
                                                    <option value="{{ $value->AllowanceListID }}">
                                                        {{ $value->AllowanceTitle }}</option>
                                                    <?php endforeach ?>
                                            </div>
                                            </select>
                                        </div>
                                    ...
                                    <tbody>
                                        @foreach ($emp_salary as $key => $value)
                                            <tr>
                                                ...
                                                <td class="col-md-1">
                                                    <form
                                                        action="{{ route('employee.allowance.delete', $value->EmployeeAllowanceID) }}"
                                    ...
                                    <tbody>
                                        @foreach ($salary as $key => $value)
                                            <tr>
                                                <td class="col-md-1">{{ $key + 1 }}</td>
                                                <td class="col-md-1"><a
                                                        href="{{ route('employee.salary-slip', [$employee->EmployeeID, $value->SalaryID]) }}"
                                                        target="_blank">{{ $value->MonthName }}</a></td>
