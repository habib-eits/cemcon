  ...
  <div class="slip-wrapper">
    ...
    <table class="main-table">
      <thead>
        <tr>
          ...
          <th class="right-header" colspan="2">Deducations (AED)</th>
        </tr>
      </thead>
      <tbody>
        <tr>
        ...
        <tr>
          <td class="label-col">Working Days</td>
          <td class="value-col"></td>
          <td class="divider-col"></td>
        ...
        <tr>
          ...
          <td class="value-col"><strong>-</strong></td>
        </tr>
      </tbody>
    </table>
    ...
    <div class="sig-section">
      ...
      <p class="confirm-text">
        I confirm that my salary has been received in full and that all dues are settled up to date, with no outstanding balance due.
      </p>
