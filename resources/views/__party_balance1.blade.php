                    ...
                    <div class="col-12">
                        <div class="page-title-box d-print-block d-sm-flex align-items-center justify-content-between">
                            ...
                            <strong class="text-end">
                                <div align="center">
                                    {{ request()->ReportType == 'C' ? 'Creditor Customers' : 'Debitor Customers' }}</div>
                            </strong>
                            ...
                            <table class="table table-striped table-sm">
                                <tr>
                                    ...
                                    <td width="10%" bgcolor="#CCCCCC">
                                        <div class="text-start"><strong>Party</strong></div>
                                    </td>
                                    <td width="40%" bgcolor="#CCCCCC">
                                        <div align="left"><strong>NAME</strong></div>
                                    </td>
                                    <td width="16%" bgcolor="#CCCCCC">
                                        <div align="right"><strong>OPENING BALANCE</strong></div>
                                    </td>
                                    <td width="16%" bgcolor="#CCCCCC">
                                        <div align="right"><strong>DEBIT</strong></div>
                                    </td>
                                    <td width="16%" bgcolor="#CCCCCC">
                                        <div align="right"><strong> CREDIT </strong></div>
                                    </td>
                                    <td width="16%" bgcolor="#CCCCCC">
