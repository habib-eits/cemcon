...
<div class="main-content">
    ...
    <div class="page-content">
        ...
        <div class="container-fluid">
            ...
            <form action="{{URL('/EstimateUpdate')}}" method="post" class="custom-validation">
                ...
                <input type="hidden" name="EstimateMasterID" value="{{request()->id}}">
                ...
                <div class="card shadow-sm">
                    ...
                    <div class="card-body">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="mb-1 row">
                                    ...
                                    <div class="col-sm-9">
                                        ...
                                        <select name="PartyID" id="PartyID" class="form-select select2 mt-5" required=""
                                            ...
                                            <option value="{{$value->PartyID}}" {{($value->PartyID==

                                                $estimate_master[0]->PartyID) ? 'selected=selected':''
                                ...
                                <div class="mb-1 row " id="WalkinCustomer">
                                    ...
                                    <div class="col-sm-9">
                                        ...
                                        <input type="text" class="form-control" name="WalkinCustomerName" value=""
                                    ...
                                    <div class="col-sm-9">
                                        ...
                                        <select name="UserID" id="UserID" class="form-select select2" style="width:100%;>
                                            ...
                                            <?php foreach ($user as $key => $value) : ?>
                                                ...
                                                <option value=" {{$value->UserID}}" {{($value->UserID==

                                            $estimate_master[0]->UserID) ? 'selected=selected':'' }}
                                ...
                                <div class="mb-1 row d-none">
                                    ...
                                    <div class="col-sm-9">
                                        ...
                                        <input type="text" id="first-name" class="form-control" name="Subject" value=""
                                ...
                                <div class="mb-1 row">
                                    ...
                                    <div class="col-sm-3">
                                        ...
                                        <label class="col-form-label" for="password">Inquiry Date </label>

                                    </div>

                                    <div class="col-sm-9">

                                        <input type="date" id="first-name" class="form-control" name="InquiryDate"

                                            value="{{$estimate_master[0]->InquiryDate}}"
                                ...
                                <div class="mb-1 row ">
                                    ...
                                    <div class="col-sm-9">
                                        ...
                                        <input type="text" id="first-name" class="form-control" name="InquiryNo"
                                            ...
                                            value="{{$estimate_master[0]->InquiryNo}}">
                                ...
                                <div class="mb-1 row">
                                    ...
                                    <div class="col-sm-9">
                                        ...
                                        <input type="text" id="first-name" class="form-control"
                                            ...
                                            value="{{$estimate_master[0]->EquipmentUser_PlantSite}}">
                                ...
                                <div class="mb-1 row">
                                    ...
                                    <div class="col-sm-9">
                                        ...
                                        <input type="text" id="first-name" class="form-control" name="VendorReference"

                                            value="{{$estimate_master[0]->VendorReference}}">
                                ...
                                <div class="mb-1 row">
                                    ...
                                    <div class="col-sm-9">
                                        ...
                                        <input type="text" id="first-name" class="form-control" name="OriginMaterial"

                                            value="{{$estimate_master[0]->OriginMaterial}}">
                                ...
                                <div class="mb-1 row">
                                    ...
                                    <div class="col-sm-9">
                                        ...
                                        <select name="TaxType" id="TaxType" class="form-select">
                                            ...
                                            <option value="TaxInclusive" {{($estimate_master[0]->TaxType=='TaxInclusive'

                                                ) ? 'selected=selected':'' }}>Tax Inclusive</option>

                                            <option value="TaxExclusive" {{($estimate_master[0]->TaxType=='TaxExclusive'

                                                ) ? 'selected=selected':'' }}>Tax Exclusive</option>
                                    ...
                                    <div class="mb-1 row">
                                        ...
                                        <div class="col-sm-9">
                                            ...
                                            <select name="BranchID" id="BranchID" class="form-select">
                                                ...
                                                <option value="{{$value->BranchID}}" {{($value->BranchID==

                                                    $estimate_master[0]->BranchID) ? 'selected=selected':''
                                    ...
                                    <div class="mb-1 row">
                                        ...
                                        <div class="col-sm-9">
                                            ...
                                            <div id="invoict_type"> <input type="text" name="EstimateNo"
                                                    ...
                                                    autocomplete="off" id="EstimateNo" class="form-control" required=""

                                                    value="{{$estimate_master[0]->EstimateNo}}"></div>
                                        ...
                                        <div class="col-sm-9">
                                            ...
                                            <div class="input-group" id="datepicker21">
                                                ...
                                                <input type="text" name="Date" autocomplete="off" class="form-control"
                                                    ...
                                                    data-date-autoclose="true" value="{{$estimate_master[0]->Date}}">
                                    ...
                                    <div class="mb-1 row">
                                        ...
                                        <div class="col-sm-9">
                                            ...
                                            <div class="input-group" id="datepicker22">
                                                ...
                                                <input type="text" name="ExpiryDate" autocomplete="off"
                                                    ...
                                                    value="{{$estimate_master[0]->ExpiryDate}}">
                                    ...
                                    <div class="mb-1 row">
                                        ...
                                        <div class="col-sm-9">
                                            ...
                                            <input type="text" name="ReferenceNo" autocomplete="off"
                                                ...
                                                class="form-control" value="{{$estimate_master[0]->ReferenceNo}}">
                                    ...
                                    <div class="mb-1 row">
                                        ...
                                        <div class="col-sm-9">
                                            ...
                                            <input type="text" name="Country" autocomplete="off" class="form-control"
                                                ...
                                                value="{{$estimate_master[0]->Country}}">
                                ...
                                <div class="col-12">
                                    ...
                                    <div class="mb-1 row">
                                        ...
                                        <div class="col-sm-9">
                                            ...
                                            <input type="text" name="Equipment" autocomplete="off" class="form-control"

                                                value="{{$estimate_master[0]->Equipment}}">
                                    ...
                                    <div class="mb-1 row">
                                        ...
                                        <div class="col-sm-9">
                                            ...
                                            <input type="text" name="SectionalAssemblyGroup" autocomplete="off"
                                                ...
                                                value="{{$estimate_master[0]->SectionalAssemblyGroup}}">
                                ...
                                <table>
                                    ...
                                    <thead>
                                        ...
                                        <tr class=" borde-1 border-light " style="height: 40px;">
                                            ...
                                            <th width="1%" align="center"><input id="check_all" type="checkbox" /></th>
                                        ...
                                        <tr class="p-3">
                                            ...
                                            <td valign="top">
                                                ...
                                                <select name="ItemID0[]" id="ItemID0_{{$no}}"
                                                    ...
                                                    <option value="{{$value->ItemID}}" {{($value->ItemID==

                                                        $value1->ItemID) ? 'selected=selected':'' }}
                                                ...
                                                <textarea name="Description[]" id="Description[]" rows="2"
                                                    ...
                                                    class="form-control mt-1 kashif"
                                            ...
                                            <td valign="top"><select name="UnitName[]" id="UnitName_{{$no}}"
                                                    ...
                                                    <option value="{{$value->UnitName}}" {{($value->

                                                        UnitName==$value1->UnitName) ? 'selected=selected' : ''}}
                                            ...
                                            <td valign="top">
                                                ...
                                                <input type="number" name="UnitQty[]" id="UnitQty_{{$no}}"
                                                    ...
                                                    onpaste="return false;" step="0.01" value="{{$value1->UnitQty}}">
                                            ...
                                            <td valign="top">
                                                ...
                                                <select class="form-select mt-1" name="LS[]" id="LS_{{$no}}">

                                                    <option value="YES" {{($value1->LS== 'YES') ? 'selected=selected':''

                                                        }} > L/S YES</option>

                                                    <option value="NO" {{($value1->LS== 'NO') ? 'selected=selected':''
                                        ...
                                        <label class="col-form-label" for="password">Salesperson </label>
                                            ...
                                            <td valign="top">
                                                ...
                                                <input type="number" name="Gross[]" id="Gross_{{$no}}"
                                                    ...
                                                    onpaste="return false;" step="0.01" value="{{$value1->Gross}}">
                                            ...
                                            <td valign="top">
                                                ...
                                                <select name="Tax[]" id="TaxID_{{$no}}" required=""
                                                    ...
                                                    <option value="{{$valueX1->TaxPer}}" {{($valueX1->TaxPer==

                                                        $value1->TaxPer) ? 'selected=selected':''
                                            ...
                                            <td valign="top">
                                                ...
                                                <input type="number" name="TaxVal[]" id="TaxVal_{{$no}}"
                                                    ...
                                                    onpaste="return false;" step="0.01" value="{{$value1->Tax}}">
                        ...
                        <div class="row mt-1 mb-2" style="margin-left: 21px;">
                            ...
                            <div class='col-xs-5 col-sm-3 col-md-3 col-lg-3  '>
                                ...
                                <div id="QtyTotal" class="form-control" style="border: 1px dashed red; width: 112px;">
                        ...
                        <div class="row mt-4">
                            ...
                            <div class="col-lg-8 col-12  ">
                                ...
                                <textarea class="form-control editme" rows='5' name="CustomerNotes" id="note"

                                    placeholder="">{!!$estimate_master[0]->CustomerNotes!!}</textarea>
                                ...
                                <textarea class="form-control editme " rows='5' name="DescriptionNotes" id="note">

                                   {!!$estimate_master[0]->DescriptionNotes!!}
                                ...
                                <label for="" class="mt-2">Covering Letter</label>

                                <textarea class="form-control editme" rows='5' name="CoveringLetter"

                                    id="CoveringLetter">



                                          {!!$estimate_master[0]->CoveringLetter!!}
                                    ...
                                    <div class="form-group mt-1">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control" id="grandtotaltax"
                                                ...
                                                onpaste="return false;" value="{{$estimate_master[0]->Tax}}">
                                    ...
                                    <div class="form-group mt-1">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control" id="subTotal" name="SubTotal"
                                                ...
                                                value="{{$estimate_master[0]->SubTotal}}">
                                    ...
                                    <div class="form-group mt-1">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" name="DiscountAmount" class="form-control"
                                                ...
                                                value="{{$estimate_master[0]->Discount}}">
                                    ...
                                    <div class="form-group mt-1">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="number" name="Total" id="Total" class="form-control"
                                                ...
                                                onpaste="return false;" value="{{$estimate_master[0]->Total}}">
                                    ...
                                    <div class="form-group mt-1 d-none ">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="number" name="Shipping" class="form-control" step="0.01"
                                                ...
                                                id="shipping" placeholder="Grand Total"
                                    ...
                                    <div class="form-group mt-1">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="number" name="Grandtotal" id="Grandtotal" class="form-control"
                                                ...
                                                onpaste="return false;" value="{{$estimate_master[0]->GrandTotal}}">
                                    ...
                                    <div class="form-group mt-1 d-none">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="number" class="form-control" id="amountPaid" name="amountPaid"
                                                ...
                                                ondrop="return false;" onpaste="return false;" step="0.01" value="0">
...
<script id="rendered-js">
    ...
    tinymce.init({
        ...
        selector : "textarea", // Select all textarea exluding the mceNoEditor class
...
<script>
    ...
    //     html += '<td valign="top"> <input type="number" name="UnitQty[]" id="UnitQty_'+ i + '" class=" form-control changesNo " autocomplete="off" onkeypress="return IsNumeric(event);" ondrop="return false;" onpaste="return false;" step="0.01" value="">                                            </td>';





    //      html += '<td valign="top"><input type="text" name="Qty[]" id="Qty_' + i + '" class="form-control changesNo QtyTotal" autocomplete="off" onkeypress="return IsNumeric(event);" ondrop="return false;" onpaste="return false;" value="1"> <select  class="form-select mt-1" name="LS[]" id="LS_' + i + '"><option value="YES"> L/S YES</option>        <option value="NO">LS / NO</option>    </select></td>';
...
$(".addmore").on('click', function() {
    ...
    let html = '<tr class="border-1 border-light">';
    ...
    html += '<select name="UnitName[]" id="UnitName_' + i + '" class="form-select">';

    @foreach($unit as $value)

    html += '<option value="{{$value->UnitName}}">{{$value->UnitName}}</option>';
    ...
    html += '<input type="number" name="UnitQty[]" id="UnitQty_' + i + '" class="form-control changesNo" autocomplete="off" onkeypress="return IsNumeric(event);" ondrop="return false;" onpaste="return false;" step="0.01" value="">';
    ...
    html += '<input type="text" name="Qty[]" id="Qty_' + i + '" class="form-control changesNo QtyTotal" autocomplete="off" onkeypress="return IsNumeric(event);" ondrop="return false;" onpaste="return false;" value="1">';

    html += '<select class="form-select mt-1" name="LS[]" id="LS_' + i + '">';

    html += '<option value="YES">L/S YES</option>';

    html += '<option value="NO">LS / NO</option>';
    ...
    html += '<input type="text" name="Price[]" id="Price_' + i + '" class="form-control changesNo" autocomplete="off" onkeypress="return IsNumeric(event);" ondrop="return false;" onpaste="return false;">';

    html += '</td>';



    html += '<td valign="top" class="d-none">';

    html += '<div class="input-group">';

    html += '<input type="text" name="Discount[]" id="Discount_' + i + '" class="form-control changesNo" autocomplete="off" onkeypress="return IsNumeric(event);" ondrop="return false;" onpaste="return false;" step="0.01" value="0">';

    html += '<span>';

    html += '<div class="col-sm-9 input-group">';

    html += '<select name="DiscountType[]" id="DiscountType_' + i + '" class="form-select changesNo bg-light">';

    html += '<option value="1">%</option>';

    html += '<option value="2">{{session::get('Currency')}}</option>';

    html += '</select>';

    html += '<input type="hidden" name="DiscountAmountItem[]" value="0" id="DiscountAmount_' + i + '">';
    ...
    html += '<input type="number" name="Gross[]" id="Gross_' + i + '" class="form-control changesNo" autocomplete="off" onkeypress="return IsNumeric(event);" ondrop="return false;" onpaste="return false;" step="0.01">';
    ...
    html += '<select name="Tax[]" id="TaxID_' + i + '" class="form-control changesNo exclusive_cal bg-light">';

    @foreach ($tax as $key => $valueX1)

    html += '<option value="{{$valueX1->TaxPer}}">{{$valueX1->Description}}</option>';
    ...
    html += '<input type="number" name="TaxVal[]" id="TaxVal_' + i + '" class="form-control totalLinePrice2" autocomplete="off" onkeypress="return IsNumeric(event);" ondrop="return false;" onpaste="return false;" step="0.01" value="0">';
    ...
    html += '<input type="text" name="ItemTotal[]" id="ItemTotal_' + i + '" class="form-control totalLinePrice" autocomplete="off" onkeypress="return IsNumeric(event);" ondrop="return false;" onpaste="return false;">';
        ...
        $('.totalLinePrice').each(function() {
            ...
            if ($(this).val() != '') subTotal += parseFloat($(this).val());
...

                {
                   ...
                   subTotal1 = parseFloat(subTotal)-parseFloat(grandtotaltax);
