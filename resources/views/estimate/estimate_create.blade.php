...
<div class="main-content">
    ...
    <div class="page-content">
        ...
        <form class="pl-lg-2" id="contactForm">
                                        ...
                                        <tr class="p-3">
                                            ...
                                            <td valign="top">
                                                ...
                                                <textarea name="Description[]" id="Description[]" rows="2"
                                                    ...
                                                    class="form-control mt-1  tiny-editor"
                                            ...
                                            <td valign="top">
                                                ...
                                                <input type="number" name="Qty[]" id="Qty_1"
                                                    ...
                                                    onpaste="return false;" step="0.01" value="1"> <select

                                                    class="form-select mt-1" name="LS[]" id="LS_1">
                        ...
                        <div class="row mt-4">
                            ...
                            <div class="col-lg-8 col-12  ">
                                ...
                                <textarea class="form-control editme" rows='5' name="CustomerNotes" id="note"
                                    ...
                                    placeholder=""><strong>Duration:</strong> 10-12 Working Days<br>

<strong>General:</strong> <strong>CEMCON Mechanical Engineering LLC</strong> reserves the right to modify this quotation<br>

Should the terms or Items ordered differ from what is stated herein?<br>

The quoted prices are based on actual costs of wages and materials as they are valid today. The quotation is subject to alterations serving technical advance.<br>

5% VAT will be added in all invoices</textarea>
                                ...
                                <textarea class="form-control editme " rows='5' name="DescriptionNotes" id="note"><strong>50% - Advance<br>

30% - After Material shifting<br>

20% - During finishing</strong><br>

If you have any questions, please do not hesitate to contact CEMCON Mechanical Engineering LLC.<br>

We look forward to receiving your valued purchase order.</textarea>
...
We thank you for your inquiry and are pleased to provide you with this quotation.<br>

This quotation expressly made conditioned upon Buyer’s agreement to and acceptance of the given technical and commercial details along with terms and conditions for sale, Service, and delivery, which are in lieu of any terms set forth in any form or document provided to us by the Buyer whether in a purchase order or otherwise.<Br><Br>

<strong>Note:</strong><br>

The prices in this offer are based on current raw material costs and exchange rates, should these values vary significantly between date of offer and order placement we reserve the right to adjust our pricing accordingly.
...
<script>
    $('#contactForm').on('submit', function(e) {
        ...
        $.ajax({
            ...
            <div id="success-alert" class="alert alert-warning alert-dismissible fade show mt-2" role="alert">
                This quotation expressly made conditioned upon Buyer’s agreement to and acceptance of the given technical and commercial details along with terms and conditions for sale, Service, and delivery, which are in lieu of any terms set forth in any form or document provided to us by the Buyer whether in a purchase order or otherwise.
                <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
            </div>
        `);

                    $('#success-alert').text(res.message);
                   ...
                   setTimeout(function() {
                    ...
                    }, 5000); // 5 seconds delay before auto-hiding
