        ...
        <div class="card">
            <div class="card-body p-4">
                ...
                <ul class="list-unstyled categories-list">
                    ...
                    <li>
                        <a href="{{ route('employee.salary', $employeeId) }}"
                    ...
                    <li>
                        <a href="{{ route('employee.letters', $employeeId) }}"
                            class="text-body d-flex align-items-center">
    ...
    font-size-16 me-2"></i> <span
                                class="me-auto">Leave</span> <i class="mdi mdi-circle-medium text-danger ms-2"></i>
                        </a>
                    </li>
                    <li>
                        <a href="{{ URL('/EmployeeLeaveReport') }}" class="text-body d-flex align-items-center">
                            <i class="mdi mdi-calendar-cursor
    font-size-16 me-2"></i> <span class="me-auto">Leave
                                Report</span>
                        </a>
                    </li>
                    <li>
    ...
    text-muted font-size-18 me-2"></i> <span
                    ...
                    <li>
                        <a href="{{ route('employee.letters.warnings', $employeeId) }}"
                            class="text-body d-flex align-items-center">
    ...
    font-size-18 text-muted me-2"></i> <span
                                class="me-auto">Supervising</span>
                        </a>
                    </li>
                    ...
                    <li>
                        <a href="{{ URL('/SalarySlip') }}" class="text-body d-flex align-items-center">
                            <i class="mdi mdi-account-supervisor-circle
    font-size-18 text-muted me-2"></i> <span
                                class="me-auto">Salary Slip</span>
                        </a>
                    </li>
                    <!--   <li>
