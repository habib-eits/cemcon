                        ...
                        <div class="row">
                            <div class="col-md-6">
                                    ...
                                    <div class="col-sm-9">
                                        <select name="PartyID" id="PartyID" class="form-select select2 mt-5"   required="" style="width:100%;">
                                            ...
                                            <?php foreach ($party as $key => $value) : ?>
                                                <option value="{{$value->PartyID}}" >{{$value->PartyName}}</option> <?php endforeach ?>
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="mb-1 row">
                                  ...
                                  <div class="mb-1 row ">
                                    <div class="col-sm-3">
                                        <label class="col-form-label" for="password">P.O #</label> 
                                    </div>

                                 <div class="col-sm-9">
                                        <select name="PO" id="PO" class="form-select select2" style="width: 100%;">
                                            <option value="">---SELECT---</option>}
                                            option
 ...
 <option value="TaxExclusive" selected>Tax Exclusive</option>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="col-12">
                                    <div class="mb-1 row">
                                        <div class="col-sm-3">
                                            <label class="col-form-label " for="password">Branch </label>
                                        </div>
                                        <div class="col-sm-9">
                                ...
                                <div class="col-12">
                                    <div class="mb-1 row">
                                        <div class="col-sm-3">
                                            <label class="col-form-label  " for="password">Invoice # </label>
                                        </div>
                                        <div class="col-sm-9">
                                            <div id="invoict_type"> <input type="text" name="InvoiceNo" autocomplete="off" id="InvoiceNo" class="form-control" required=""></div>
                                    ...
                                    <tbody>
                                        <tr class="p-3" >
                                          ...
                                          <input type="number" name="UnitQty[]" id="UnitQty_1" class=" form-control changesNo  " autocomplete="off" onkeypress="return IsNumeric(event);" ondrop="return false;" onpaste="return false;" step="0.01" value="">                                            </td>
                                             ...
                                             <td valign="top">
                                          <input type="number" name="Qty[]" id="Qty_1" class=" form-control changesNo QtyTotal" autocomplete="off" onkeypress="return IsNumeric(event);" ondrop="return false;" onpaste="return false;" step="0.01" value="1">           <select  class="form-select mt-1" name="LS[]" id="LS_1"><option value="YES"> L/S YES</option>        <option value="NO">LS / NO</option>    </select>                                   </td>
                        ...
                        <div class="row mt-4">
                            ...
                            <div class="col-lg-8 col-12  ">
                                <h6>Customer Notes: </h6>
                                 ...
                                 <textarea class="form-control editme" rows='5' name="CustomerNotes" id="note" placeholder=""> </textarea>
