                                    ...
                                    <div class="col-sm-9">
                                        <select name="JobID" id="JobID" class="form-select select2 mt-5"   required="" style="width:100%;">
                                            ...
                                            <?php foreach ($job as $key => $value) : ?>
                                                <option value="{{$value->JobID}}" {{($value->JobID== $invoice_master[0]->JobID) ? 'selected=selected':'' }}>{{$value->JobNo}}</option> <?php endforeach ?>
                                        </select>
                                    </div>
                                </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="col-12">
                                    <div class="mb-1 row">
                                        ...
                                        <div class="col-sm-9">
                                            <div id="invoict_type"> <input type="text" name="InvoiceNo" autocomplete="off" id="InvoiceNo" class="form-control" required="" value="{{$invoice_master[0]->InvoiceNo}}"></div>
