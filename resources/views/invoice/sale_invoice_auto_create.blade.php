...
<h3>UPDATE INVOICE</h3>
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                    ...
                                    <div class="col-sm-9">
                                        <select name="PartyID" id="PartyID" class="form-select select2 mt-5"   required="" style="width:100%;">
                                            ...
                                            <?php foreach ($party as $key => $value) : ?>
                                                <option value="{{$value->PartyID}}" {{($value->PartyID== $invoice_master[0]->PartyID) ? 'selected=selected':'' }}>{{$value->PartyName}}</option> <?php endforeach ?>
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="mb-1 row">
                                    <div class="col-sm-3">
                                        <label class="col-form-label" for="password">Job  </label>
                                    </div>
                                    <div class="col-sm-9">
                                        <select name="JobID" id="JobID" class="form-select select2 mt-5"   required="" style="width:100%;">
                                            <option value="">Select</option>
                                            <?php foreach ($job as $key => $value) : ?>
                                                <option value="{{$value->JobID}}" >{{$value->JobNo}}</option> <?php endforeach ?>
                                        </select>
                                    </div>
                                </div>
 ...
 <option value="TaxInclusive" {{($invoice_master[0]->TaxType=='TaxInclusive' ) ? 'selected=selected':'' }}>Tax Inclusive</option>
 <option value="TaxExclusive" {{($invoice_master[0]->TaxType=='TaxExclusive' ) ? 'selected=selected':'' }}>Tax Exclusive</option>
 </select>
                                    </div>
                                </div>
                            ...
                            <div class="col-md-6">
                                        ...
                                        <div class="col-sm-9">
                                            <select name="BranchID" id="BranchID" class="form-select">
                                                <?php foreach ($branch as $key => $value) : ?>
                                                    <option value="{{$value->BranchID}}" {{($value->BranchID== $invoice_master[0]->BranchID) ? 'selected=selected':'' }}>{{$value->BranchName}}</option>
                                                <?php endforeach ?>
                                            </select>
                                ...
                                <div class="col-12">
                                    <div class="mb-1 row">
                                        ...
                                        <div class="col-sm-9">
                                            <div id="invoict_type"> <input type="text" name="InvoiceNo" autocomplete="off" id="InvoiceNo" class="form-control" required="" value="{{$invoice_master[0]->EstimateNo}}"></div>
                                ...
                                <div class="col-12">
                                    <div class="mb-1 row">
                                        <div class="col-sm-3">
                                            <label class="col-form-label" for="email-id"> Invoice Date</label>
                                        </div>
                                        <div class="col-sm-9">
                                    ...
                                    <div class="mb-1 row">
                                        ...
                                        <div class="col-sm-9">
                                            <div class="input-group" id="datepicker22">
                                                <input type="text" name="DueDate" autocomplete="off" class="form-control" placeholder="yyyy-mm-dd" data-date-format="yyyy-mm-dd" data-date-container="#datepicker22" data-provide="datepicker" data-date-autoclose="true" value="{{$invoice_master[0]->ExpiryDate}}">
                                                <span class="input-group-text"><i class="mdi mdi-calendar"></i></span>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-12">
                                    <div class="mb-1 row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" name="ReferenceNo" autocomplete="off" class="form-control" value="{{$invoice_master[0]->EstimateNo}}">
                                    ...
                                    <tbody>
                                        ...
                                        <tr class="p-3" >
                                          ...
                                          <td valign="top">
                                                ...
                                                <input type="hidden" name="ItemID[]" id="ItemID_1" value="{{$value1->ItemID}}">
                                          <textarea name="Description[]" id="Description[]" rows="2" class="form-control mt-1 " style="width: 300px !important;">{{$value1->Description}}</textarea></td>

                                          <td valign="top"><select name="UnitName[]" id="UnitName_1" class="form-select">

                                              
                                              @foreach($unit as $value)
                                              <option value="{{$value->UnitName}}"  {{($value->UnitName==$value1->UnitName) ? 'selected=selected' : ''}} >{{$value->UnitName}}</option>
                                              @endforeach

                                          </select></td>

                                             <td valign="top">
                                          <input type="number" name="UnitQty[]" id="UnitQty_1" class=" form-control changesNo  " autocomplete="off" onkeypress="return IsNumeric(event);" ondrop="return false;" onpaste="return false;" step="0.01" value="{{$value1->UnitQty}}">                                            </td>


                                             <td valign="top">
                                          <input type="number" name="Qty[]" id="Qty_1" class=" form-control changesNo QtyTotal" autocomplete="off" onkeypress="return IsNumeric(event);" ondrop="return false;" onpaste="return false;" step="0.01" value="{{$value1->Qty}}">           <select  class="form-select mt-1" name="LS[]" id="LS_1"><option value="YES" {{($value1->LS== 'YES') ? 'selected=selected':'' }} > L/S YES</option>        <option value="NO" {{($value1->LS== 'NO') ? 'selected=selected':'' }}>LS / NO</option>    </select>                                   </td>

                                            <td valign="top">
                                          <input type="number" name="Price[]" id="Price_1" class=" form-control changesNo" autocomplete="off" onkeypress="return IsNumeric(event);" ondrop="return false;" onpaste="return false;" step="0.01" value="{{$value1->Rate}}">                                            </td>
                                        ...
                                        <label class="col-form-label" for="password">Salesperson </label>
                                           ...
                                           <td valign="top">
                                          <input type="number" name="Gross[]" id="Gross_1" class=" form-control changesNo" autocomplete="off" onkeypress="return IsNumeric(event);" ondrop="return false;" onpaste="return false;" step="0.01" value="{{$value1->Gross}}">                                            </td>
                                            <td valign="top">
                                            ...
                                            <td valign="top">
                                          <input type="number" name="TaxVal[]" id="TaxVal_1" class=" form-control totalLinePrice2" autocomplete="off" onkeypress="return IsNumeric(event);" ondrop="return false;" onpaste="return false;" step="0.01" value="{{$value1->Tax}}">                                            </td>

                                            <td valign="top">
                                          <input type="number" name="ItemTotal[]" id="ItemTotal_1" class=" form-control totalLinePrice " autocomplete="off" onkeypress="return IsNumeric(event);" ondrop="return false;" onpaste="return false;" step="0.01" value="{{$value1->Total}}">                                            </td>
                                        </tr>
                        ...
                        <div class="row mt-4">
                            ...
                            <div class="col-lg-8 col-12  ">
                                <h6>Customer Notes: </h6>
                                 ...
                                 <textarea class="form-control editme" rows='5' name="CustomerNotes" id="note" placeholder=""> {{$invoice_master[0]->CustomerNotes}}</textarea>

                                <label for="" class="mt-2">Description</label>
                               <textarea class="form-control editme " rows='5' name="DescriptionNotes" id="note"
                                         > {{$invoice_master[0]->DescriptionNotes}}</textarea>
                                ...
                                <form class="form-inline">
                                    <div class="form-group mt-1">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control" id="grandtotaltax" name="grandtotaltax" placeholder="Subtotal" onkeypress="return IsNumeric(event);" ondrop="return false;" onpaste="return false;" value="{{$invoice_master[0]->Tax}}">
                                        </div>
                                    </div>
                                    <div class="form-group mt-1">
                                    ...
                                    <div class="form-group mt-1">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" name="DiscountAmount" class="form-control" id="discountAmount" onkeypress="return IsNumeric(event);" ondrop="return false;" onpaste="return false;" value="{{$invoice_master[0]->Discount}}">
                                        </div>
                                    </div>
