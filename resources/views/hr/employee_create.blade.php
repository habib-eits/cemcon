                            ...
                            <div class="card shadow-sm">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="mb-3">
                                                <label for="emp_pic" class="pr-5">Staff Picture</label><br>
                                        ...
                                        <div class="col-md-4">
                                            <div class="mb-3">
                                                  <label for="input-date1">Date of Birth <span class="text-danger">*</span></label>
                                      ...
                                      <div class="col-md-4 ">
                                            <div class="mb-3">
                                                ...
                                                <input type="date"
                                                      ...
                                                      id="VisaIssueDate"
                                                      class="form-control"
                                                      value="{{ old('VisaIssueDate') }}">

                                                <span class="text-muted">Select the visa issue date</span>
                                            </div>
                                      </div>
                                      ...
                                      <div class="col-md-4">
                                          <div class="mb-3">
                                              ...
                                              <input type="date"
                                                    ...
                                                    id="PassportExpiry"
                                                    class="form-control"
                                                    value="{{ old('PassportExpiry') }}">

                                              <span class="text-muted">Select the Passport Expiry Date</span>
                                          </div>
                                    ...
                                    <div class="row">
                                                ...
                                                <select name="SupervisorID" id="SupervisorID" class="form-select select2">
                                                      ...
                                                      @foreach ($supervisor as $value)
                                                          <option value="{{ $value->EmployeeID }}"
                                                              {{ old('SupervisorID') == $value->EmployeeID ? 'selected' : '' }}>
                                                              {{ $value->full_name }}
                                                          </option>
                                                      @endforeach
                                                </select>
                                        ...
                                        <div class="col-md-4">
                                            <div class="mb-3">
                                                ...
                                                <span class="text-muted">Select the joining date</span>
                                            </div>
