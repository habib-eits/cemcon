                    ...
                    <div class="col-xl-9">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <form action="{{ URL('/EmpAllowanceSave') }}" method="post" class="outer-repeater">
                                    {{ csrf_field() }}
                                    ...
                                    <tbody>
                                        @foreach ($emp_salary as $key => $value)
                                            <tr>
                                                ...
                                                <td class="col-md-1"><a
                                                        href="{{ URL('/EmpAllowanceDelete/') . '/' . $value->EmployeeAllowanceID }}">Delete</a>
                                                </td>
                                            </tr>
                                        @endforeach
                                    </tbody>
                                ...
                                <table class="table table-sm align-middle table-nowrap mb-0">
                                    ...
                                    <tbody>
                                        @foreach ($salary as $key => $value)
                                            <tr>
                                                <td class="col-md-1">{{ $key + 1 }}</td>
                                                <td class="col-md-1"><a href="{{ URL('/SalarySlip/' . $value->SalaryID) }}"
